...
class COCOPoseMetric(BaseMetric):
    ...
    Examples:
        ...
        >>> import copy
        >>> from mmeval.fileio import load
        >>> from mmeval import CocoPoseMetric
        >>> try:
        ...     from xtcocotools.coco import COCO
        ...     from xtcocotools.cocoeval import COCOeval
        ...     HAS_XTCOCOTOOLS = True
        ...
        DONE (t=0.00s).
        Average Precision  (AP) @[ IoU=0.50:0.95 | area=   all | maxDets= 20 ] =  1.000  # noqa
        ...
        OrderedDict([('AP', 1.0), ('AP .5', 1.0), ('AP .75', 1.0), ('AP (M)', 1.0),
        ('AP (L)', 1.0), ('AR', 1.0), ('AR .5', 1.0), ('AR .75', 1.0),
        ('AR (M)', 1.0), ('AR (L)', 1.0)])
    """
            ...
            groundtruths (Sequence[dict]): A sequence of dict. If load from
                ...
                keys:
                    ...
                    - `raw_ann_info` (dict): The raw annotation information
                        ...
                        compute `COCOPoseMetric`, there are some required
                        keys in the `raw_ann_info`:
