...
from mmeval.metrics import COCOPoseMetric
...
class TestCOCOPoseMetric(TestCase):
    ...
    def test_init(self):
        ...
        with self.assertRaisesRegex(ValueError,
            ...
            _ = COCOPoseMetric(ann_file=self.ann_file, score_mode='keypoint')

        # test nms_mode option
        with self.assertRaisesRegex(ValueError, '`nms_mode` should be one of'):
            _ = COCOPoseMetric(ann_file=self.ann_file, nms_mode='invalid')
    ...
    def test_format_only(self):
        ...
        with self.assertRaisesRegex(
            ...
            _ = COCOPoseMetric(ann_file=tmp_ann_file, format_only=False)
    ...
    def test_evaluate(self):
        ...
        metric_crowdpose = COCOPoseMetric(
